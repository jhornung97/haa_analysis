...
# with command line options: Configuration/GenProduction/python/EXO-RunIISummer20UL18wmLHEGEN-02295-fragment.py --python_filename EXO-RunIISummer20UL18wmLHEGEN-02295_1_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN,LHE --fileout file:EXO-RunIISummer20UL18wmLHEGEN-02295.root --conditions 106X_upgrade2018_realistic_v4 --beamspot Realistic25ns13TeVEarly2018Collision --step LHE,GEN --geometry DB:Extended --era Run2_2018 --no_exec --mc -n 276
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/EXO-RunIISummer20UL18wmLHEGEN-02295-fragment.py nevts:276'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:EXO-RunIISummer20UL18wmLHEGEN-02295_inLHE.root'),
...
process.generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            'POWHEG:nFinal = 3', 
            '9000006:all = sk   skbar    0        0          0       1.5  1.9732e-12  1.0  75.0 0', 
            '9000006:oneChannel = 2  1.000 101  221 -221', 
            '9000006:mayDecay = on', 
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed = cms.untracked.uint32(options.seed)
