...
# with command line options: --python_filename EXO-RunIISummer20UL18HLT-03853_1_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --fileout file:EXO-RunIISummer20UL18HLT-03853.root --conditions 102X_upgrade2018_realistic_v15 --customise_commands process.source.bypassVersionCheck = cms.untracked.bool(True) --step HLT:2018v32 --geometry DB:Extended --filein file:EXO-RunIISummer20UL18DIGIPremix-03853.root --era Run2_2018 --no_exec --mc -n 1000
