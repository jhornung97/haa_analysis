...
sample_name="/DYJetsToMuMu_M-50_TuneCP5_ZptWeighted_13TeV-powhegMiNNLO-pythia8-photos/RunIISummer20UL17NanoAODv9-106X_mc2017_realistic_v9-v2/NANOAODSIM"
nick="DYJetsToMuMu_M-50_TuneCP5_ZptWeighted_13TeV-powhegMiNNLO-pythia8-photos"

echo "dbs: ${sample_name}" > ${nick}.yaml
echo "era: 2017" >> ${nick}.yaml
echo "filelist:" >> ${nick}.yaml

dasgoclient -query="file dataset=${sample_name}" | xargs  -n1 -P1 -i echo - cms-xrd-global.cern.ch/{} >> ${nick}.yaml
