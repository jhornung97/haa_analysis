...
ttbar = uproot.open("/ceph/jhornung/analysis/2018/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8+RunIISummer20UL18MiniAODv2-106X_upgrade2018_realistic_v16_L1v1-v1+MINIAODSIM/%s/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8+RunIISummer20UL18MiniAODv2-106X_upgrade2018_realistic_v16_L1v1-v1+MINIAODSIM.root"%scope)

ttbar_ntuples = ttbar['ntuple']
ttbar_branches = ttbar_ntuples.arrays()

ww = uproot.open("/ceph/jhornung/analysis/2018/WWTo2L2Nu_TuneCP5_13TeV-powheg-pythia8+RunIISummer20UL18MiniAODv2-106X_upgrade2018_realistic_v16_L1v1-v2+MINIAODSIM/%s/WWTo2L2Nu_TuneCP5_13TeV-powheg-pythia8+RunIISummer20UL18MiniAODv2-106X_upgrade2018_realistic_v16_L1v1-v2+MINIAODSIM.root"%scope)

ww_ntuples = ww['ntuple']
ww_branches = ww_ntuples.arrays()

zz = uproot.open("/ceph/jhornung/analysis/2018/ZZTo2L2Nu_TuneCP5_13TeV_powheg_pythia8+RunIISummer20UL18MiniAODv2-106X_upgrade2018_realistic_v16_L1v1-v1+MINIAODSIM/%s/ZZTo2L2Nu_TuneCP5_13TeV_powheg_pythia8+RunIISummer20UL18MiniAODv2-106X_upgrade2018_realistic_v16_L1v1-v1+MINIAODSIM.root"%scope)

zz_ntuples = zz['ntuple']
zz_branches = zz_ntuples.arrays()

wz_three_l_nu = uproot.open("/ceph/jhornung/analysis/2018/WZTo3LNu_mllmin4p0_TuneCP5_13TeV-powheg-pythia8+RunIISummer20UL18MiniAODv2-106X_upgrade2018_realistic_v16_L1v1-v2+MINIAODSIM/%s/WZTo3LNu_mllmin4p0_TuneCP5_13TeV-powheg-pythia8+RunIISummer20UL18MiniAODv2-106X_upgrade2018_realistic_v16_L1v1-v2+MINIAODSIM.root"%scope)

wz_three_l_nu_ntuples = wz_three_l_nu['ntuple']
wz_three_l_nu_branches = wz_three_l_nu_ntuples.arrays()

wz_l_three_nu = uproot.open("/ceph/jhornung/analysis/2018/WZTo1L3Nu_4f_TuneCP5_13TeV-amcatnloFXFX-pythia8+RunIISummer20UL18MiniAODv2-106X_upgrade2018_realistic_v16_L1v1-v3+MINIAODSIM/%s/WZTo1L3Nu_4f_TuneCP5_13TeV-amcatnloFXFX-pythia8+RunIISummer20UL18MiniAODv2-106X_upgrade2018_realistic_v16_L1v1-v3+MINIAODSIM.root"%scope)

wz_l_three_nu_ntuples = wz_l_three_nu['ntuple']
wz_l_three_nu_branches = wz_l_three_nu_ntuples.arrays()

wh = uproot.open("/ceph/jhornung/analysis/2018/merged_mc/%s/wh.root"%scope)

wh_ntuples = wh['ntuple']
wh_branches = wh_ntuples.arrays()

singletop = uproot.open("/ceph/jhornung/analysis/2018/merged_mc/%s/singletop.root"%scope)

singletop_ntuples = singletop['ntuple']
singletop_branches = singletop_ntuples.arrays()

signal = uproot.open("/ceph/jhornung/analysis/2018/HaaKKKK_M125_13TeV_powheg_pythia8-RunIISummer20UL18MiniAODv2-106X/%s/HaaKKKK_M125_13TeV_powheg_pythia8-RunIISummer20UL18MiniAODv2-106X.root"%scope)
...
data = uproot.open("/ceph/jhornung/analysis/2018/single_muon_data/%s/single_muon_data.root"%scope)
...
if scope == 'em':
    for i, f in enumerate(files):
        weight = 59e3*np.array(list(map(useful_stuff.weights,f['genWeight'])))*f['evtweight'].to_numpy()
        weights.append(weight)

    signal_weights = np.array(list(map(useful_stuff.weights,signal_branches['genWeight'])))*signal_branches['evtweight'].to_numpy()
    ...
    for i, f in enumerate(files):
        ...
        masks.append(mask)
        weight = 59e3*np.array(list(map(useful_stuff.weights,f['genWeight'][mask])))*f['evtweight'][mask].to_numpy()
        weights.append(weight)
