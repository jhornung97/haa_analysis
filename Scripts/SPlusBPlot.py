...
print(" ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Haa MODEL PLOTTER RUN II ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ")
...
def parse_options():
    ...
    parser.add_option("--blindingRegion", dest="blindingRegion", default="110,140", help="Region in xvar to blind")
    ...
    parser.add_option("--xvar", dest="xvar", default=r"H_mass_2018_mm,m_{4K},GeV", help="X-variable: name,title,units")
